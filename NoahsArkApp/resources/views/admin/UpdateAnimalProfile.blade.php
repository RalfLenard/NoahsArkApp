                        ...
                        <h5>Welcome Jhon Deo , Love to see you back. </h5>
                         ...
                         <form action="{{ route('admin.store-animal-profile') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="profile_picture">Old Profile Picture:</label>
                                <img width="250px" height="300px" src="{{ Storage::url($animalProfiles->profile_picture) }}" class="card-img-top" alt="{{ $animalProfiles->name }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="description" value="{{$animalProfiles->description}}" rows="4" required></textarea>
                            </div>

                            <div class="form-group">
                                <label for="name">Name:</label>
                                <input type="text" class="form-control" name="name" id="name" value="{{$animalProfiles->name}}" required>
                            </div>

                            <div class="form-group">
                                <label for="age">Age:</label>
                                <input type="number" class="form-control" name="age" id="age" value="{{$animalProfiles->age}}"   required>
                            </div>

                            <div class="form-group">
                                <label for="medical_records">Medical Records:</label>
                                <textarea class="form-control" name="medical_records" id="medical_records" value="{{$animalProfiles->medical_records}}" rows="4" required></textarea>
                            </div>
